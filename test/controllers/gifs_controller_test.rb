...
class GifsControllerTest < ActionController::TestCase
  ...
  test "should create gif" do
    assert_difference('Gif.count') do
      post :create, gif: { description: @gif.description, image_url: @gif.image_url, tags: @gif.tags, title: @gif.title }
    end
  ...
  test "should update gif" do
    patch :update, id: @gif, gif: { description: @gif.description, image_url: @gif.image_url, tags: @gif.tags, title: @gif.title }
    assert_redirected_to gif_path(assigns(:gif))
  end
